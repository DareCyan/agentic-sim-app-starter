...
const langDict = {
  zh: {
    ...
    'config.model': '模型',
    'config.model-ph': 'gpt-4o',
    'config.save': '保存',
    'config.validating': '验证中...',
    'config.valid': '验证通过',
    'config.invalid': '验证失败',
    'config.saved': '已保存',
    'config.validate-fail': '请先完成有效的大模型配置校验',
    'config.save-fail': '保存失败',
    'exc.add-btn': '✦ 新增故障场景',
    'exc.add-title': '新增异常场景',
    'exc.add-placeholder': '描述一个异常场景...',
    'exc.add-ai-btn': '✦ 智能识别',
    'exc.add-classifying': '✦ 智能识别中...',
    'exc.add-confirm': '确认添加',
    'exc.add-result': '✦ 智能识别结果',
    'exc.add-app': '应用',
    'exc.add-flow': '流程',
    'exc.add-category': '故障分类 (L2)',
    'exc.add-l3': '故障类型 (L3)',
    'exc.add-desc': '故障描述',
    'exc.add-pri': '风险等级',
    'exc.add-new-app': '+ 新建应用分类',
    'exc.add-new-flow': '+ 新建流程',
    'exc.add-generic-or-new': '选择归属',
    'exc.add-generic-hint': '此应用可归属"通用"分类，或创建新的专属分类',
    'exc.add-use-generic': '归属通用',
    'exc.add-create-new': '创建新分类',
    'exc.add-new-app-ph': '新应用分类名称',
    'exc.add-new-flow-ph': '新流程名称',
    'exc.add-new-l2': '+ 新建故障分类',
    'exc.add-new-l2-ph': '新故障分类名称',
    'exc.add-new-l3-ph': '新故障类型名称',
    'exc.add-no-llm': '请先在右上角 ⚙ 中配置大模型 API',
    'exc.add-questions': '示例场景',
    'exc.add-questions-ph': '每行一个示例场景，例如：\n用户打开微信后页面白屏\n点击发送按钮无响应',
    'exc.add-error': '识别失败，请重试',
    'exc.add-inserted': '已添加',
  },
  en: {
    ...
    'config.saved': 'Saved',
    'config.validate-fail': 'Please complete valid LLM configuration first',
    'config.save-fail': 'Save failed',
    'exc.add-btn': '✦ Add Fault Scenario',
    'exc.add-title': 'New Exception Scenario',
    'exc.add-placeholder': 'Describe an exception scenario...',
    'exc.add-ai-btn': '✦ Smart Classify',
    'exc.add-classifying': 'Classifying...',
    'exc.add-confirm': 'Confirm',
    'exc.add-result': '✦ Classification Result',
    'exc.add-app': 'App',
    'exc.add-flow': 'Flow',
    'exc.add-category': 'Fault Category (L2)',
    'exc.add-l3': 'Fault Type (L3)',
    'exc.add-desc': 'Description',
    'exc.add-pri': 'Priority',
    'exc.add-new-app': '+ New App Category',
    'exc.add-new-flow': '+ New Flow',
    'exc.add-generic-or-new': 'Choose Classification',
    'exc.add-generic-hint': 'This app can be classified as "Generic" or as a new specific category',
    'exc.add-use-generic': 'Use Generic',
    'exc.add-create-new': 'Create New',
    'exc.add-new-app-ph': 'New app category name',
    'exc.add-new-flow-ph': 'New flow name',
    'exc.add-new-l2': '+ New Category',
    'exc.add-new-l2-ph': 'New category name',
    'exc.add-new-l3-ph': 'New fault type name',
    'exc.add-no-llm': 'Please configure LLM API in ⚙ settings first',
    'exc.add-questions': 'Example Scenarios',
    'exc.add-questions-ph': 'One scenario per line, e.g.:\nScreen goes blank after opening WeChat\nSend button unresponsive',
    'exc.add-error': 'Classification failed, please retry',
    'exc.add-inserted': 'Added',
  },
};
